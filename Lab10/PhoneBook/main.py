...
def inputCSV(conn):
    ...
    try:
        ...
        with open(r"C:\Users\pc\Documents\aktantsis\Lab10\PhoneBook\data.csv", 'r') as file:
...
def queryData(conn):
    try:
        ...
        if choice == '1':
            ...
            print("Queried data:")
            with open(r"C:\Users\pc\Documents\aktantsis\Lab10\PhoneBook\querriedData.txt", "w") as file:
